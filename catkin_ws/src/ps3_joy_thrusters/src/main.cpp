...
#include "ps3.h"
#include "ps3_joy_thrusters/JolnerActuators.h"
#include <math.h>
...
{
  vel_pub_ = nh_.advertise<ps3_joy_thrusters::JolnerActuators>("input/jolner/actuators", 0);
...
{
  ps3_joy_thrusters::JolnerActuators actuators;
  actuators.rightRPM = 1*(joy->axes[right_thr])*3000;
  actuators.leftRPM = 1*(joy->axes[left_thr])*3000;
