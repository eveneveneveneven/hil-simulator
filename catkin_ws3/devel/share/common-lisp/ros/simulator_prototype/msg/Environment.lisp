...
(cl:defmethod cl:initialize-instance :after ((m <Environment>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Environment)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulator_prototype-msg:<Environment> is deprecated: use simulator_prototype-msg:Environment instead.")))

(cl:ensure-generic-function 'paused-val :lambda-list '(m))
(cl:defmethod paused-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator_prototype-msg:paused-val is deprecated.  Use simulator_prototype-msg:paused instead.")
  (paused m))
...
(cl:defmethod meanWindSpeed-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator_prototype-msg:meanWindSpeed-val is deprecated.  Use simulator_prototype-msg:meanWindSpeed instead.")
  (meanWindSpeed m))

(cl:ensure-generic-function 'meanWindDirection-val :lambda-list '(m))
(cl:defmethod meanWindDirection-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator_prototype-msg:meanWindDirection-val is deprecated.  Use simulator_prototype-msg:meanWindDirection instead.")
  (meanWindDirection m))

(cl:ensure-generic-function 'meanCurrentSpeed-val :lambda-list '(m))
(cl:defmethod meanCurrentSpeed-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator_prototype-msg:meanCurrentSpeed-val is deprecated.  Use simulator_prototype-msg:meanCurrentSpeed instead.")
  (meanCurrentSpeed m))

(cl:ensure-generic-function 'meanCurrentDirection-val :lambda-list '(m))
(cl:defmethod meanCurrentDirection-val ((m <Environment>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulator_prototype-msg:meanCurrentDirection-val is deprecated.  Use simulator_prototype-msg:meanCurrentDirection instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Environment>)))
  ...
  "simulator_prototype/Environment")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Environment)))
  "Returns string type for a message object of type 'Environment"
  "simulator_prototype/Environment")
